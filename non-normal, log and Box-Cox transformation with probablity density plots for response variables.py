# -*- coding: utf-8 -*-
"""
Created on Wed May 12 15:49:26 2021
...
sns.distplot(w, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[0,0])
sns.distplot(log_scalar_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[0,1])
sns.distplot(fitted_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[0,2])
  
#w- non-normal, log and box-cox
sns.distplot(d, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[1,0])
sns.distplot(log_scalar_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[1,1])
sns.distplot(fitted_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[1,2])
...
#plus_CV_w- non-normal, log and box-cox
sns.distplot(CV_w, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[4,0])
sns.distplot(log_scalar_CV_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[4,1])
sns.distplot(fitted_CV_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[4,2])
 
#plus_Std_d- non-normal, log and box-cox
sns.distplot(CV_w, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[5,0])
sns.distplot(log_scalar_CV_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[5,1])
sns.distplot(fitted_CV_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[5,2])
 
#plus_Std_w- non-normal, log and box-cox
sns.distplot(Std_w, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[6,0])
sns.distplot(log_scalar_Std_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[6,1])
sns.distplot(fitted_Std_w, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[6,2])
 
#plus_Std_d- non-normal, log and box-cox
sns.distplot(Std_d, hist = True, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = "Non-Normal", color ="grey", ax = ax[7,0])
sns.distplot(log_scalar_Std_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "log", color ="red", ax = ax[7,1])
sns.distplot(fitted_Std_d, hist = True, kde = True,  kde_kws = {'shade': True, 'linewidth': 2}, label = "Box-cox", color ="blue", ax = ax[7,2])
