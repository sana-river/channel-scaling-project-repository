# -*- coding: utf-8 -*-
"""
Created on Fri Jul 30 17:10:45 2021
...
color_dict= {1: 'navy', 2: 'cornflowerblue', 3: 'white', 4: 'lightsalmon', 5: 'maroon'}
...
p1 = sns.boxplot(x="StreamOrde", y="width", data=df, palette=color_dict, linewidth=1.5, showfliers=True, ax= ax[0])
p2 = sns.boxplot(x="StreamOrde", y="depth", data=df, palette=color_dict, linewidth=1.5, showfliers=True, ax= ax[1])
